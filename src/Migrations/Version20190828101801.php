 ...
 */
final class Version20190828101801 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__member AS SELECT id, user_first_name, user_last_name, birthday, image, civility, first_name, last_name, email, phone_number, mobile_number, address, postcode, city, infos, created_at, updated_at FROM member');
        ...
        $this->addSql('INSERT INTO member (id, user_first_name, user_last_name, birthday, image, civility, first_name, last_name, email, phone_number, mobile_number, address, postcode, city, infos, created_at, updated_at) SELECT id, user_first_name, user_last_name, birthday, image, civility, first_name, last_name, email, phone_number, mobile_number, address, postcode, city, infos, created_at, updated_at FROM __temp__member');
