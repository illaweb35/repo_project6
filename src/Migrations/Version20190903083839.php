 ...
 */
final class Version20190903083839 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE member (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, lesson_id INTEGER NOT NULL, user_first_name VARCHAR(255) NOT NULL COLLATE BINARY, user_last_name VARCHAR(255) NOT NULL COLLATE BINARY, birthday DATETIME NOT NULL, image VARCHAR(255) DEFAULT NULL COLLATE BINARY, civility VARCHAR(60) DEFAULT NULL COLLATE BINARY, first_name VARCHAR(255) NOT NULL COLLATE BINARY, last_name VARCHAR(255) NOT NULL COLLATE BINARY, email VARCHAR(255) NOT NULL COLLATE BINARY, phone_number VARCHAR(60) DEFAULT NULL COLLATE BINARY, mobile_number VARCHAR(60) DEFAULT NULL COLLATE BINARY, address VARCHAR(255) DEFAULT NULL COLLATE BINARY, post_code VARCHAR(60) DEFAULT NULL COLLATE BINARY, city VARCHAR(255) DEFAULT NULL COLLATE BINARY, infos CLOB DEFAULT NULL COLLATE BINARY, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, image_caption VARCHAR(255) DEFAULT NULL COLLATE BINARY, older INTEGER NOT NULL, CONSTRAINT FK_70E4FA78CDF80196 FOREIGN KEY (lesson_id) REFERENCES lesson (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__member AS SELECT id, lesson_id, user_first_name, user_last_name, birthday, image, civility, first_name, last_name, email, phone_number, mobile_number, address, post_code, city, infos, created_at, updated_at, image_caption FROM member');
        $this->addSql('DROP TABLE member');
        $this->addSql('CREATE TABLE member (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, lesson_id INTEGER NOT NULL, user_first_name VARCHAR(255) NOT NULL, user_last_name VARCHAR(255) NOT NULL, birthday DATETIME NOT NULL, image VARCHAR(255) DEFAULT NULL, civility VARCHAR(60) DEFAULT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone_number VARCHAR(60) DEFAULT NULL, mobile_number VARCHAR(60) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, post_code VARCHAR(60) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, infos CLOB DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, image_caption VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO member (id, lesson_id, user_first_name, user_last_name, birthday, image, civility, first_name, last_name, email, phone_number, mobile_number, address, post_code, city, infos, created_at, updated_at, image_caption) SELECT id, lesson_id, user_first_name, user_last_name, birthday, image, civility, first_name, last_name, email, phone_number, mobile_number, address, post_code, city, infos, created_at, updated_at, image_caption FROM __temp__member');
        $this->addSql('DROP TABLE __temp__member');
        $this->addSql('CREATE INDEX IDX_70E4FA78CDF80196 ON member (lesson_id)');
    }
