 ...
 */
final class Version20190828172915 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , password VARCHAR(255) NOT NULL, pseudo VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, image_caption VARCHAR(255) DEFAULT NULL)');
        ...
        $this->addSql('CREATE TABLE professor (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, phone_number VARCHAR(60) DEFAULT NULL, mobile_number VARCHAR(60) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, post_code VARCHAR(60) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, image_caption VARCHAR(255) DEFAULT NULL)');
