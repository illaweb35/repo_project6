 ...
 */
final class Version20190828115741 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE member (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, lesson_id INTEGER NOT NULL, user_first_name VARCHAR(255) NOT NULL COLLATE BINARY, user_last_name VARCHAR(255) NOT NULL COLLATE BINARY, birthday DATETIME NOT NULL, image VARCHAR(255) DEFAULT NULL COLLATE BINARY, civility VARCHAR(60) DEFAULT NULL COLLATE BINARY, first_name VARCHAR(255) NOT NULL COLLATE BINARY, last_name VARCHAR(255) NOT NULL COLLATE BINARY, email VARCHAR(255) NOT NULL COLLATE BINARY, phone_number VARCHAR(60) DEFAULT NULL COLLATE BINARY, mobile_number VARCHAR(60) DEFAULT NULL COLLATE BINARY, address VARCHAR(255) DEFAULT NULL COLLATE BINARY, postcode VARCHAR(60) DEFAULT NULL COLLATE BINARY, city VARCHAR(255) DEFAULT NULL COLLATE BINARY, infos CLOB DEFAULT NULL COLLATE BINARY, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, image_caption VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_70E4FA78CDF80196 FOREIGN KEY (lesson_id) REFERENCES lesson (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
