 ...
 */
final class Version20190828103102 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__dance AS SELECT id, title, slug, sub_title, content, image, created_at, updated_at FROM dance');
        ...
        $this->addSql('INSERT INTO dance (id, title, slug, sub_title, content, image, created_at, updated_at) SELECT id, title, slug, sub_title, content, image, created_at, updated_at FROM __temp__dance');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__dance AS SELECT id, title, slug, sub_title, content, image, created_at, updated_at FROM dance');
        $this->addSql('DROP TABLE dance');
        $this->addSql('CREATE TABLE dance (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, sub_title VARCHAR(255) NOT NULL, content CLOB NOT NULL, image VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL)');
        $this->addSql('INSERT INTO dance (id, title, slug, sub_title, content, image, created_at, updated_at) SELECT id, title, slug, sub_title, content, image, created_at, updated_at FROM __temp__dance');
        $this->addSql('DROP TABLE __temp__dance');
        $this->addSql('DROP INDEX IDX_F87474F365D64EDD');
        $this->addSql('CREATE TEMPORARY TABLE __temp__lesson AS SELECT id, dance_id, title, slug, sub_title, day_lesson, start_hour, end_hour, duration, amount, address, post_code, city, created_at, updated_at FROM lesson');
