 ...
 */
final class Version20190828115403 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, category_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, slug VARCHAR(255) NOT NULL COLLATE BINARY, subtitle VARCHAR(255) NOT NULL COLLATE BINARY, content CLOB DEFAULT NULL COLLATE BINARY, image VARCHAR(255) DEFAULT NULL COLLATE BINARY, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, image_caption VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_23A0E6612469DE2 FOREIGN KEY (category_id) REFERENCES category (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__dance AS SELECT id, professor_id, title, slug, sub_title, content, image, created_at, updated_at FROM dance');
        $this->addSql('DROP TABLE dance');
        $this->addSql('CREATE TABLE dance (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, professor_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, slug VARCHAR(255) NOT NULL COLLATE BINARY, sub_title VARCHAR(255) NOT NULL COLLATE BINARY, content CLOB NOT NULL COLLATE BINARY, image VARCHAR(255) DEFAULT NULL COLLATE BINARY, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, CONSTRAINT FK_184BFD6F7D2D84D5 FOREIGN KEY (professor_id) REFERENCES professor (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO dance (id, professor_id, title, slug, sub_title, content, image, created_at, updated_at) SELECT id, professor_id, title, slug, sub_title, content, image, created_at, updated_at FROM __temp__dance');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__dance AS SELECT id, professor_id, title, slug, sub_title, content, image, created_at, updated_at FROM dance');
        $this->addSql('DROP TABLE dance');
        $this->addSql('CREATE TABLE dance (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, professor_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, sub_title VARCHAR(255) NOT NULL, content CLOB NOT NULL, image VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL)');
        $this->addSql('INSERT INTO dance (id, professor_id, title, slug, sub_title, content, image, created_at, updated_at) SELECT id, professor_id, title, slug, sub_title, content, image, created_at, updated_at FROM __temp__dance');
        $this->addSql('DROP TABLE __temp__dance');
        $this->addSql('CREATE INDEX IDX_184BFD6F7D2D84D5 ON dance (professor_id)');
        $this->addSql('DROP INDEX IDX_F87474F365D64EDD');
